...
2. 幽默：笑点来自一本正经的推演或反差，而非夸张语气、感叹号、热梗
...
群聊记录（JSON 数组，每条含 time / sender / content；有头像的额外含 uid 发言人编号）：
{messages}
...
[
  {
    "title": "一句话概括这段对话在聊什么",
    "lines": [
      { "uid": "发言人编号", "sender": "昵称", "content": "发言原文" },
      { "sender": "昵称", "content": "第二条发言原文（该记录没有 uid）" }
    ],
    "reason": "笑点在哪"
  }
]
