...
function renderDialogue(dialogue: HighlightDialogue<HighlightLine>): string {
...
export function renderDialoguesHtml(digest: DialogueDigest<HighlightLine>, config: RenderStyleConfig): string {
